...
def _format_instructions() -> str:
    return (
        ...
        "- First line must be exactly: Answer: A OR Answer: B OR Answer: D\n"
...
def generate_factorial_prompt_cases_abd(n: int = 100, seed: int = 20260127) -> List[PromptCase]:
    """Generate 100 English prompt cases with choices restricted to A/B/D (no C)."""
