...
def _build_implementation_report_markdown(
    *,
    ...
    lines.append("5. Sequence and maze summary tables from native output files.")
    lines.append("6. Combined paper main table for cross-section metric loading.")
    lines.append("7. Release checklist and manifest for reproducibility handoff.")
    lines.append("")
    ...
    lines.append("3. Use `paper_main_table.csv` as the source for figure/table scripts.")
    lines.append("4. Keep `manifest.json` with the camera-ready artifact bundle.")
...
def build_submission_package(
    *,
    ...
    paper_rows = _build_paper_main_table(decision_rows, sequence_rows, maze_rows)
